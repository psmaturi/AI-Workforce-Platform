...
async def test_agent():
    ...
    queries = [
        "Hello",
        "What skills are required for the EAF Mechanical Specialist role?",
        "I am Gareth. What skills am I missing for the EAF Mechanical Specialist role?",
        "What training should Gareth complete?"
    ]
